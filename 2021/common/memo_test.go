...
func TestMemo(t *testing.T) {
	f1 := Memo(func(a int) int { return a })
	f2 := Memo2(func(a float32, b float64) float64 { return float64(a) + b })
	f3 := Memo3(func(a string, b int, c any) any { return c })
	f4 := Memo4(func(a string, b int, c float32, d error) bool { return d.Error() != "" })
